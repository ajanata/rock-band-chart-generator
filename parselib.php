...
function parseVocals($txt) {
    ...
    foreach ($track as $line) {
        ...
        if ($info[1] == "Meta" && $info[2] == "Text") continue;
        
        if ($info[1] == "Meta" && $info[2] == "Lyric") {
