...
function makeChart($file, $diff, $game, $instrument, $name = null) {
	...
	global $HEIGHT;
	$HEIGHT = $y + 125 + 75 * ($instrument == "vocals");
...
//	$fill = imagecolorallocate($im, 255, 255, 180);
	...
	imagestring($im, 3, 0, $HEIGHT - 30, "http://www.ajanata.com/charts/" . strtolower($game) . "/" . strtolower($instrument) . "/", $gray);
...
function drawMeasureBackground($im, $x, $y, $meas, $events, $sections, $instrument, $difficulty) {
	...
	// section name -- FIXME changed to an event
