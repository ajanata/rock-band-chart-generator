...
<ul>
<li>Fixed more issues with time signatures that are not x/4. Thanks to CTangent for reporting. Problems were only noticed in Prequel to the Sequel and Colony of Birchmen, but every song with a time signature that is not x/4 (about 24 songs in total) have been re-drawn. This mainly affect background colors (for OD phrases, for instance), but also affected some sustains going between measures.</li>
<li>Vocal activation zones. See below for more details, but they should be right in almost, if not, every case.</li>
<li>Guitar and bass hammer-ons. Hammer-on gems are 1 px shorter both above and below the staff line (2 px total). They aren't quite as easy to see as I would like, but making them any smaller makes them too hard to see against some backgrounds. These hammer-on gems take all of the game-wide default hammer-on window, any possible per-song hammer-on window, and forced hammer-on and strum note sections into account when displaying. Sorry, <b>Rock Band 1 players, this takes the forced strum/hopo information in Rock Band 2 into account</b> -- you'll just have to ignore them on the recent DLC.</li>
</ul></p>
