...
<ul>
<li>Added a bunch of stuff to the CSV file.</li>
</ul></p>
...
<p><b>Note that all delay times are crurrently assuming the expert scroll speed -- even on charts for other difficulties!</b> Fixing this is on my to-do list, but is not a high priority.</p>
<p>Vocal activation zones are not stored in the .mid as they are with drums. I believe I have figured out how the game determines activation zones, but I need more time to actually make my program figure them out.</p>
